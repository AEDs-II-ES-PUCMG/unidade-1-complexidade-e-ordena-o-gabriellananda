...
public class Pedido implements Comparable<Pedido>{
    ...
    public double indiceEconomia() {
    	...
    	for (ItemDePedido item : itens) {
			if (item != null) {
				double valorAtual = item.getProduto().valorDeVenda() * item.getQuantidade();
				double valorCongelado = item.getPrecoVenda();
				economia += (valorAtual - valorCongelado);
			}
    	}
    	return economia;
    }
	...
	public double getValorFinalPedido() {
		// TODO Auto-generated method stub
		throw new UnsupportedOperationException("Unimplemented method 'getValorFinalPedido'");
	}
